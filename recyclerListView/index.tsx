...
import {ScrollView, View, Button, RefreshControl, Alert} from 'react-native';
    ...
    <Tester style={{flex: 1}}>
      <ScrollView>
        <TestSuite name="recyclerlistview">
          ...
          <TestCase
            key={'canChangeSize'}
            itShould={`属性canChangeSize 当前为：${canChangeSize},`}
            tags={['C_API']}
            initialState={false}
            arrange={({setState}) => {
              return (
                <View style={{width: width - 40, height: 250}}>
                  <RecyclerListView
                    ...
                    dataProvider={defaultDataProvider}
                    rowRenderer={rowRenderer}
                    layoutSize={layoutCanChangeSize}
            ...
            arrange={({setState, state}) => {
              return (
                <View style={{width: width - 40, height: 250}}>
                  <RecyclerListView
                    layoutProvider={defaultLayoutProvider}
                    dataProvider={getDataProvider(100)}
                    rowRenderer={rowRenderer}
